...
$sqlQuery = "SELECT * FROM personas WHERE identificacion LIKE '%$busqueda%' or nombre LIKE '%$busqueda%' or apellido LIKE '%$busqueda%'or direccion like '%$busqueda%'or celular like '%$busqueda%' or telefono LIKE '%$busqueda%' or correo like '%$busqueda%'"; 
                    ...
                    <div id="nav-mobile" class="right hide-on-med-and-down nav-wrapper teal lighten-1" style="margin-right: 10px;">
                        <form method="POST" action="buscar.php">
                            <div class="input-field">
                                <input id="search" type="search" name="buscador" value="<?php echo $busqueda ?>">
